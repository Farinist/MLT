...
------------ | ---------| --------
*Precision*  | 97.26%   | 30.75%
*Recall*     | 77.41%   | 82.18%
*F1-Score*   | 86.21%   | 44.75%
Akurasi                            | 77.94%
...
Metrik       | Not safe  | Safe
------------ | ----------| -------
*Precision*  | 99.15%    | 55.82%
*Recall*     | 90.95%    | 93.67%
*F1-Score*   | 94.87%    | 69.95%
Akurasi                             | 91.25%

Berdasarkan hasil evaluasi diatas menunjukkan bahwa hasil akurasi kedua algoritma berbeda jauh. Algoritma *Decision Tree* menghasilkan performa yang lebih baik dibandingkan dengan algoritma *K-Nearest Neighbor*. 

Algoritma *K-Nearest Neighbor* menghasilkan akurasi sebesar 77.94% ketika nilai k=6. Pada label "not safe", rata-rata dari nilai *precision* sebesar 97.26%, nilai *recall* sebesar 77.41%, dan nilai *f1-score* sebesar 86.21%. Sedangkan pada label "safe" rata-rata dari nilai *precision* sebesar 30.75%, nilai *recall* sebesar 82.18%, dan nilai *f1-score* sebesar 44.75%.

Algoritma *Decision Tree* menghasilkan akurasi sebesar 91.25%. Pada label "not safe", rata-rata dari nilai *precision* sebesar 99.15%, nilai *recall* sebesar 90.95%, dan nilai *f1-score* sebesar 94.87%. Sedangkan pada label "safe" rata-rata dari nilai *precision* sebesar 55.82%, nilai *recall* sebesar 93.67%, dan nilai *f1-score* sebesar 69.95%.
